...
staticplot = ggplot(tops_format, aes(-rank, group = prenom, 
  ...
  geom_text(aes(x=-7,y=Inf,label = "Anvioù-bihan", hjust=0.5,vjust=0.5), colour="gray50",fontface="bold",size=24) +
  geom_text(aes(x=-8,y=Inf,label = "a gaver e Breizh", hjust=0.5,vjust=0.5), colour="black",family="Ubuntu Light",fontface="bold",size=24) +
